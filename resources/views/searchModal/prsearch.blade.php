<div class="modal fade" id="modalPRSearch" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title titleview">Purchase Request Search</h5>
			...
			<div class="modal-body">
				...
				<table class="align-items-center table-flush prsearchtable w-100 table">
				</table>
			</div>
...
<script src="{{ asset('/') }}js/search/searchPR.js" type="module"></script>
