                            ...
                            <div class="card-header border-0">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label class="form-control-label" for="example3cols1Input">PIC <span
                                                        style="color: red">*</span></label>
                                                <input type="text" class="form-control form-control-sm inputpic"
                                                    id="example3cols1Input"
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label class="form-control-label" for="example3cols1Input">Transaction Date
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label class="form-control-label" for="example3cols1Input">Location<span
                                                        style="color: red">*</span></label>
                                                <input type="text" class="form-control form-control-sm inputlocation"
                                                    id="example3cols1Input"
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label class="form-control-label" for="example3cols1Input">Duration(Days)
                                                    <span style="color: red">*</span></label>
                                                <input type="number" class="form-control form-control-sm inputduration"
                                                    id="example3cols1Input"
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <div class="datatotaltermin"
                                                    data-totaltermin="{{ $sessionRoute == 'admin.addProjectView' ? '' : $data['dataProject']['total_termin'] }}">
                                                </div>
                                                <label class="form-control-label" for="example3cols1Input">Total
                                                    Termin<span style="color: red">*</span></label>
                                                <select class="form-control form-control-sm inputtotaltermin">
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="form-control-label" for="example3cols1Input">COA For Expense
                                                <span style="color: red">*</span></label>
                                            <div class="d-flex">
                                                <input type="text" readonly
                                                    class="form-control form-control-sm inputcoaekspense"
                                                    id="example3cols1Input"
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="form-control-label" for="example3cols1Input">COA For Account
                                                Payable <span style="color: red">*</span></label>
                                            <div class="d-flex">
                                                <input type="text" readonly
                                                    class="form-control form-control-sm inputcoapayable"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <small class="text-danger"> <i>Type File : pdf | jpg | jpeg | png | xls
                                            </i></small><br>
