...
@section('content')
                    ...
                    <div class="col-lg-6 col-7">
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('admin.capitalchange') }}">Capital Change</a>
                                </li>
                            </ol>
                        </nav>
                    </div>
                    ...
                    <div class="col">
                        <div class="card" style="min-height: 800px">
                            ...
                            <div class="card-header border-0">
                                <h3 class="mb-0">Statement of Change in Capital Report</h3>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-7">
                                            <div class="mr-1 mt-5">
    ...
    <script src="{{ asset('/') }}js/accounting/changeofcapital.js" type="module"></script>
@endsection
