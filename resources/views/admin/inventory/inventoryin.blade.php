...
@section('content')
					...
					<div class="col-lg-6 col-7">
						<nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
							<ol class="breadcrumb breadcrumb-links breadcrumb-dark">
								...
								<li class="breadcrumb-item active" aria-current="page">InventoryIn</li>
							</ol>
						</nav>
					</div>
				</div>
					...
					<div class="col">
						<div class="card" style="min-height: 800px">
							...
							<div class="card-body">
								...
								<table class="align-items-center table-flush iintable w-100 table">
	...
	<script src="{{ asset('/') }}js/inventory/inventoryin.js" type="module"></script>
@endsection
