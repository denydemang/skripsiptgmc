                ...
                @if (count($stocks) > 0)
                    @foreach ($stocks as $item)
                        @php
                            ...
                            if ($item->keterangan == 'Pembelian' || $item->keterangan == 'Sisa Material Proyek') {
                        ...
                        <tr>
                            ...
                            <td>{{ $item->keterangan == 'Pembelian' || $item->keterangan == 'Sisa Material Proyek' ? floatval($item->qty) : 0 }}
                            </td>
                            <td>{{ $item->keterangan != 'Pembelian' && $item->keterangan != 'Sisa Material Proyek' ? floatval($item->qty) : 0 }}
                            </td>
                            <td>{{ $BalanceQTY }}</td>
                            <td>Rp. {{ number_format($item->cogs, 2, ',', '.') }}</td>
                            <td>Rp.
                                {{ $item->keterangan == 'Pembelian' || $item->keterangan == 'Sisa Material Proyek' ? number_format($item->total_cogs, 2, ',', '.') : 0 }}
                            </td>
                            <td>Rp.
                                {{ $item->keterangan != 'Pembelian' && $item->keterangan != 'Sisa Material Proyek' ? number_format($item->total_cogs, 2, ',', '.') : 0 }}
                            </td>
