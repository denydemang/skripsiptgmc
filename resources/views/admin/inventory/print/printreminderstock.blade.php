        ...
        <table id="detail">
            <thead>
                <tr>
                    ...
                    <th style="text-align: right">Unit Code</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($stocckData as $item)
                    <tr>
                        ...
                        <td class="no-wrap" style="text-align: right">{{ floatval($item->min_stock) }}</td>
                        <td class="no-wrap" style="text-align: right">{{ floatval($item->current_stock) }}</td>
