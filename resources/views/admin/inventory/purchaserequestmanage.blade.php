                            ...
                            <div class="card-header border-0">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm inputpr_no"
                                                    readonly
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label class="form-control-label" for="example3cols1Input">PIC (Request
                                                    Person) <span style="color: red">*</span></label>
                                                <input type="text" class="form-control form-control-sm inputpicname"
                                                    id="example3cols1Input"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label class="form-control-label" for="example3cols1Input">Division<span
                                                        style="color: red">*</span></label>
                                                <input type="text" class="form-control form-control-sm inputdivision"
                                                    id="example3cols1Input"
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label class="form-control-label" for="example3cols1Input">Document Ref
                                                    No<small class="ml-2">optional</small></label>
                                                <input type="text" class="form-control form-control-sm inputrefno"
                                                    id="example3cols1Input"
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label class="form-control-label" for="example3cols1Input">Date Required
                                                    <span style="color: red">*</span></label>
                                                <div class="input-group date mr-2" id="dtpdaterequired"
                                                    data-target-input="nearest">
                                                    <input type="text" style="cursor: pointer"
                                                        class="form-control form-control-sm inputdaterequired"
                                                        data-target="#dtpdaterequired" readonly
                                                        data-daterequired="{{ $sessionRoute == 'admin.addprview' ? '' : $data['dataPR']['date_need'] }}" />
                                                    <div class="input-group-append" data-target="#dtpdaterequired"
                                                        data-toggle="dtpdaterequired">
                                                        <div class="input-group-text" style="height: 32px"><i
                                                                class="fa fa-calendar"></i></div>
                                                    </div>
                                                </div>
