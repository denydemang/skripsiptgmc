                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-4 mb-4">
                                ...
                                <div class="d-flex">
                                    <input type="text" readonly class="form-control form-control-sm inputdepositamount"
                                        id="example3cols1Input"
                                        data-depositamount="{{ $sessionRoute == 'admin.addReceiptView' ? '' : $data['deposit_amount'] }}">
                                    <button class="btn btn-sm btnallocate ml-2 text-white"
                                        style="background-color:#1d3541">Allocate
                                        All</button>
                                </div>
                            </div>
                        </div>
