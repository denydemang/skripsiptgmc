...
@section('content')
					...
					<div class="col">
						<div class="card" style="min-height: 800px">
							...
							<div class="card-body">
								...
								<br>
								<a href="{{ route('admin.addReceiptView') }}">
									<button class="btn btn-outline-primary btn-sm addbtn mb-2">
										<i class="fas fa-plus"></i> ADD NEW
									</button>
								</a>
								<div>
									<table class="align-items-center table-flush receipttable w-100 table">
										<thead class="thead-light">
											<tr>
												<th scope="col">Actions</th>
												<th scope="col">BKM No</th>
												<th scope="col">Transaction Date</th>
												<th scope="col">Customer Code</th>
												<th scope="col">Customer Name</th>
												<th scope="col">Received Via</th>
	...
	<script src="{{ asset('/') }}js/finance/receipt.js" type="module"></script>
@endsection
