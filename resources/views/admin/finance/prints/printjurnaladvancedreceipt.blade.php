...
<head>
    ...
    <title>Journal ADR {{ $advancedreceipt['adr_no'] }}</title>
    <style>
        body {
...
<body>
    ...
    <div class="header-container" style="position: relative;padding-top:120px;border-bottom:2px solid #333">
        ...
        <header style="position:absolute;top:0;left:0;padding-top:40px">
            <h3 style="margin-top:-10px;text-align:left">JOURNAL ADVANCED RECEIPT</h3>
        </header>
    </div>
        ...
        <div class="transaction-info">
            <table border="0" cellpadding="4" style="padding: 10px">
                <tr>
                    ...
                    <td>:</td>
                    <td>{{ \Carbon\Carbon::parse($advancedreceipt['transaction_date'])->format('d/m/Y') }}</td>
                </tr>
                <tr>
                    <td><strong>ADR No</strong></td>
                    <td>:</td>
                    <td>{{ $advancedreceipt['adr_no'] }}</td>
                </tr>
                <tr>
                    <td><strong>Customer Code</strong></td>
                    <td>:</td>
                    <td>{{ $advancedreceipt['customer_code'] }}</td>
                    </td>
                </tr>
                <tr>
