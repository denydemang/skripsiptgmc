                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label class="form-control-label">Cash No <span
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="d-flex">
                                            <input type="text" readonly
                                                class="form-control form-control-sm inputcoaforcashbank" style="width: 45%"
                                                id="example3cols1Input"
                                                value="{{ $sessionRoute == 'admin.addCashbookView' ? '' : $data['cashbook']['COA_Cash'] }}">
                                            <input type="text" readonly
                                                class="form-control coa-name form-control-sm inputcoaforcashbank"
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="datatype"
                                                data-datatype="{{ $sessionRoute == 'admin.addCashbookView' ? '' : $data['cashbook']['CbpType'] }}">
                                            </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label class="form-control-label"><span class="title-pay"></span> <span
                                                    style="color: red">*</span></label>
                                    ...
                                    <table border="1"
                                        ...
                                        <thead class="text-white" style="background-color:#808283">
                                            <tr>
                                                ...
                                                <th style="font-size: 10px; width:30%;text-align:right">
                                                    Amount</th>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <input type="text" readonly hidden
                                                            class="form-control form-control-sm inputcoalawancode"
                                                            style="width: 45%" id="example3cols1Input"
                                                            value="{{ $sessionRoute == 'admin.addCashbookView' ? '' : $data['cashbookdetail']['coa_code'] }}">
                                                        <input type="text" readonly hidden
                                                            class="form-control coa-name form-control-sm inputcoalawanname"
                                                            id="example3colInput" style="width: 55%"
                                                            value="{{ $sessionRoute == 'admin.addCashbookView' ? '' : $data['cashbookdetail']['coa_name'] }}">
                                                        @include('component.btnsearchcoa')
                                                    </div>
                                                </td>
                                                <td style="font-size: 12px; white-space:nowrap"><span
                                                        class="labelcoacodelawan"></span></td>
                                                <td style="font-size: 12px"><span class="labelcoanamelawan"></span></td>
                                                <td style="font-size: 22px;white-space:nowrap;text-align:right"><input
                                                        type="text"
                                                        data-amountcoalawan="{{ $sessionRoute == 'admin.addCashbookView' ? '' : floatval($data['cashbookdetail']['amount']) }}"
                                                        style="width: 100%;font-weight:bolder;color:rgb(118, 72, 116);font-size:13px;text-align:right"
                                    ...
                                    <table border="1"
                                        ...
                                        <thead class="text-white" style="background-color:#808283">
                                            <tr>
                                                ...
                                                <th class="text-left" style="font-size: 10px;width:30%">Coa Name</th>
                                                <th style="font-size: 10px; width:25%;text-align:right">
                                                    Debit</th>
                                                <th style="font-size: 10px;width:25%;text-align:right">
                                                    Kredit</th>
                                                <th class="text-left" style="font-size: 10px;width:5%">...</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="d-flex">
                                                        <input type="text" readonly hidden
                                                            class="form-control form-control-sm inputcoacodeadjustment"
                                                            style="width: 45%" id="example3cols1Input"
                                                            value="{{ $sessionRoute == 'admin.addCashbookView' ? '' : $data['cashbookdetailb']['coa_code'] }}">
                                                        <input type="text" readonly hidden
                                                            class="form-control coa-name form-control-sm inputcoanameadjustment"
                                                            id="example3colInput" style="width: 55%"
                                                ...
                                                <td style="font-size: 12px; white-space:nowrap"><span
                                                        class="labelcoacodeadjustment"></span>
                                                </td>
                                                <td style="font-size: 12px"><span class="labelcoanameadjustment"></span>
                                                </td>
                                                <td style="font-size: 22px;white-space:nowrap"><input type="text"
                                                        ...
                                                        style="width: 100%;font-weight:bolder;font-size:13px;text-align:right"
                                                        class="custom-input inputdebitadjustment" value="">
                                                </td>
                                                <td style="font-size: 22px;white-space:nowrap"><input type="text"
                                                        ...
                                                        style="width: 100%;font-weight:bolder;font-size:13px;text-align:right"
                                                        class="custom-input inputcreditadjustment" value="23131399">
                                                </td>
                                                <td>
