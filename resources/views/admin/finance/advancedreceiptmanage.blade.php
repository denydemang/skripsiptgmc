					...
					<div class="col-lg-6 col-7">
						<nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
							<ol class="breadcrumb breadcrumb-links breadcrumb-dark">
								...
								<li class="breadcrumb-item"><a href="{{ route('admin.advancedreceipt') }}">Advanced Receipt</a></li>
								...
								<div class="card-body">
									<div class="row">
										<div class="col-lg-4">
											<div class="form-group">
												<label class="form-control-label">ADR No <span style="color: red">*</span></label>
												<input type="text" class="form-control form-control-sm inputadrno" readonly
									...
									<div class="row">
										<div class="col-lg-7">
											...
											<div class="d-flex">
												<input type="text" readonly class="form-control form-control-sm inputcoacodeforcashbank"
													style="width: 45%" id="example3cols1Input"
													value="{{ $sessionRoute == 'admin.addAdvancedReceiptView' ? '' : $data['AR']['coa_code'] }}">
												<input type="text" readonly class="form-control coa-name form-control-sm inputcoanameforcashbank"
									...
									<div class="row mt-4">
										<div class="col-lg-7">
											<label class="form-control-label" for="example3cols1Input">COA For Advanced Receipt <span
													style="color: red">*</span></label>
											<div class="d-flex">
												<input type="text" readonly class="form-control form-control-sm inputcoacodeforadvancedreceipt"
													style="width: 45%" id="example3cols1Input" value="20.01.02.01">
												<input type="text" readonly class="form-control coa-name form-control-sm inputcoanameforadvancedreceipt"
													id="example3colInput" style="width: 55%" value="Uang Muka Penjualan">
											</div>
										</div>
									</div>
									<div class="row mt-4">
										<div class="col-lg-6">
											<div class="form-group">
												<label class="form-control-label">Deposit Amount <span style="color: red">*</span></label>
									...
									<div class="row">
										<div class="col-lg-8">
											...
											<button class="btn btn-primary btn-sm submitbtn mt-2 py-2"><i class="fas fa-save mr-2"
