                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label class="form-control-label">Purchase No <span
                                                        style="color: red">*</span></label>
                                                <input type="text" class="form-control form-control-sm inputpurchaseno"
                                                    readonly
                                        ...
                                        <table border="1"
                                            ...
                                            <thead class="text-white" style="background-color:#808283">
                                                <tr>
                                                    ...
                                                    <th style="font-size: 10px;width:10%;text-align:right">Qty</th>
                                                    <th style="font-size: 10px; width:15%;text-align:right">Price</th>
                                                    <th style="font-size: 10px; width:15%;text-align:right">Total</th>
                                                    <th style="font-size: 10px; width:10%;text-align:right">Discount</th>
                                                    <th style="font-size: 10px; width:20%;text-align:right">Sub Total</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                            </tbody>
                            ...
                            <div class="card-body">
                                <div class="row" style="position: relative;">
                                    <div class="col-lg-5 offset-lg-7">
                                        <div class="form-group row">
                                            <label class="form-control-label col-6"
                                                style="text-align: right;padding-top:3px">Total</label>
                                    ...
                                    <div class="col-lg-5 offset-lg-7">
                                        <div class="form-group row">
                                            <label class="form-control-label col-6"
                                                style="text-align: right;padding-top:3px">Freight In</label>
                                            <input type="text"
                                                class="form-control inputotherfee form-control-sm col-6 bg-success text-white"
                                    ...
                                    <div class="col-lg-5 offset-lg-7">
                                        <div class="form-group row">
                                            <label class="form-control-label col-6"
                                                style="text-align: right;padding-top:3px">PPN (%)</label>
                                            <input type="number"
                                                class="form-control inputpercentppn form-control-sm col-2 bg-primary text-white"
                                                style="font-weight: bold;text-align:right">
                                            <div class="datapercentppn"
                                                data-percentppn="{{ $sessionRoute == 'admin.addPurchaseView' ? '' : $data['purchases']['percen_ppn'] }}">
                                            </div>
                                            <input type="text" readonly
                                                class="form-control form-control-sm col-4 inputppnamount bg-primary text-white"
                                                style="font-weight: bold;text-align:right">
                                    ...
                                    <div class="form-group d-flex"
                                        style="position: absolute;top:0;left:0;padding-left:25px">
                                        <label class="form-control-label mr-5"
                                            style="text-align: right;padding-top:3px;font-size:25px"><b>Grand
                                                Total</b></label>
                                        <span class="bg-danger labelgrandtotal px-3 text-white"
