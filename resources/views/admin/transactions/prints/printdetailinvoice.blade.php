    ...
    <div class="receipt">
        ...
        <div class="content">
            <table>
                ...
                <tr>
                    <td style="font-weight:bold">
                        Termin {{ $invoices['termin'] }} dari {{ $invoices['total_termin'] }}
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td style="font-weight:bold">
                        : Rp
                        {{ number_format(floatval($invoices['grand_total'] - $invoices['paid_amount']), 2, ',', '.') }}
                    </td>
                </tr>
            </table>
        </div>
        @if (floatval($invoices['grand_total'] - $invoices['paid_amount']) > 0)
            ...
            <span style="padding-left:40px;font-weight:bold"><i style="padding-left:10px">{{ $terbilang }}
                    Rupiah</i> </span>
        @else
        ...
        <div class="footer" style="padding-top:80px">
            ...
            <p style="margin-bottom:90px;text-align:right;font-size:11px;font-weight:bold;padding-right:20px">PT GENTA
                MULTI
                JAYYA</p>

            <p style="text-align:right;padding-right:20px"><span
                    style="display:inline-block;padding-right:120px"></span></p>
            <p style="text-align:right;padding-right:20px"><span
                    style="border-bottom:1px solid black;width:122px;display:inline-block"></span></p>
            <p style="text-align:right;padding-right:20px"><span
                    style="padding-right:40px;font-size:11px">Direktur</span></p>
        </div>
    </div>
</body>
