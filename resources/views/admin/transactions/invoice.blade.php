...
@section('content')
					...
					<div class="col">
						<div class="card" style="min-height: 800px">
							...
							<div class="card-body">
								...
								<br>
								<a href="{{ route('admin.addInvoiceView') }}">
									<button class="btn btn-outline-primary btn-sm addbtn mb-2">
										<i class="fas fa-plus"></i> ADD NEW
									</button></a>
								<div>
									<table class="align-items-center table-flush invoicetable w-100 table">
										<thead class="thead-light">
											<tr>
												...
												<th scope="col">Project Realisation Code</th>
												<th scope="col">Project Code</th>
												<th scope="col">Project Name</th>
												<th scope="col">Bap No</th>
												<th scope="col">Bapp No</th>
												<th scope="col">Spp No</th>
												<th scope="col">COA Revenue</th>
	...
	<script src="{{ asset('/') }}js/transactions/invoice.js" type="module"></script>
@endsection
