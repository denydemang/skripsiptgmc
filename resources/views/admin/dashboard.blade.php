				...
				<div class="card card-stats">
					...
					<div class="card-body">
						<div class="row">
							...
							<div class="col-auto">
								<div class="icon icon-shape bg-gradient-orange rounded-circle text-white shadow">
				...
				<div class="card card-stats">
					...
					<div class="card-body">
						<div class="row">
							...
							<div class="col-auto">
								<div class="icon icon-shape bg-gradient-info rounded-circle text-white shadow">
					...
					<div class="card-header bg-transparent">
						<div class="row align-items-center">
							<div class="col">
								...
								<h5 class="h3 mb-0 text-white">Sales value</h5>
							</div>
							<div class="col">
								<ul class="nav nav-pills justify-content-end">
									<li class="nav-item mr-md-0 mr-2" data-toggle="chart" data-target="#chart-sales-dark"
										data-update='{"data":{"datasets":[{"data":[0, 20, 10, 30, 15, 40, 20, 60, 60]}]}}' data-prefix="$"
										data-suffix="k">
										<a href="#" class="nav-link active px-3 py-2" data-toggle="tab">
									...
									<li class="nav-item" data-toggle="chart" data-target="#chart-sales-dark"
										...
										data-suffix="k">
										<a href="#" class="nav-link px-3 py-2" data-toggle="tab">
								...
								<div class="row align-items-center">
									<div class="col-auto">
										...
										<a href="#" class="avatar rounded-circle">
											<img alt="Image placeholder" src="https://www.aragon.cm38.de/assets/img/theme/team-1.jpg" />
										</a>
									</div>
									<div class="col ml--2">
										<h4 class="mb-0">
							...
							<li class="list-group-item px-0">
								<div class="row align-items-center">
									<div class="col-auto">
										<!-- Avatar -->
										<a href="#" class="avatar rounded-circle">
											<img alt="Image placeholder" src="https://www.aragon.cm38.de/assets/img/theme/team-2.jpg" />
										</a>
									</div>
									<div class="col ml--2">
										<h4 class="mb-0">
							...
							<li class="list-group-item px-0">
								<div class="row align-items-center">
									<div class="col-auto">
										<!-- Avatar -->
										<a href="#" class="avatar rounded-circle">
											<img alt="Image placeholder" src="https://www.aragon.cm38.de/assets/img/theme/team-3.jpg" />
										</a>
									</div>
									<div class="col ml--2">
										<h4 class="mb-0">
							...
							<li class="list-group-item px-0">
								<div class="row align-items-center">
									<div class="col-auto">
										<!-- Avatar -->
										<a href="#" class="avatar rounded-circle">
											<img alt="Image placeholder" src="https://www.aragon.cm38.de/assets/img/theme/team-4.jpg" />
										</a>
									</div>
									<div class="col ml--2">
										<h4 class="mb-0">
				...
				<div class="card">
					...
					<div class="card-body p-0">
						...
						<ul class="list-group list-group-flush" data-toggle="checklist">
							<li class="checklist-entry list-group-item flex-column align-items-start px-4 py-4">
							...
							<li class="list-group-item px-0">
								<div class="row align-items-center">
									<div class="col-auto">
										<!-- Avatar -->
										<a href="#" class="avatar rounded-circle">
											<img alt="Image placeholder" src="https://www.aragon.cm38.de/assets/img/theme/bootstrap.jpg" />
										</a>
									</div>
									<div class="col">
							...
							<li class="list-group-item px-0">
								<div class="row align-items-center">
									<div class="col-auto">
										<!-- Avatar -->
										<a href="#" class="avatar rounded-circle">
											<img alt="Image placeholder" src="https://www.aragon.cm38.de/assets/img/theme/angular.jpg" />
										</a>
									</div>
									<div class="col">
							...
							<li class="list-group-item px-0">
								<div class="row align-items-center">
									<div class="col-auto">
										<!-- Avatar -->
										<a href="#" class="avatar rounded-circle">
											<img alt="Image placeholder" src="https://www.aragon.cm38.de/assets/img/theme/sketch.jpg" />
										</a>
									</div>
									<div class="col">
							...
							<li class="list-group-item px-0">
								<div class="row align-items-center">
									<div class="col-auto">
										<!-- Avatar -->
										<a href="#" class="avatar rounded-circle">
											<img alt="Image placeholder" src="https://www.aragon.cm38.de/assets/img/theme/react.jpg" />
										</a>
									</div>
									<div class="col">
				...
				<div class="card">
					...
					<div class="card-header d-flex align-items-center">
						<div class="d-flex align-items-center">
							<a href="#"> <img src="https://www.aragon.cm38.de/assets/img/theme/team-1.jpg" class="avatar" /> </a>
							<div class="mx-3">
					...
					<div class="card-body">
						...
						<img alt="Image placeholder" src="https://www.aragon.cm38.de/assets/img/theme/img-1-1000x600.jpg"
							class="img-fluid rounded" />
						<div class="row align-items-center border-bottom my-3 pb-3">
							<div class="col-sm-6">
								...
								<div class="d-flex align-items-center justify-content-sm-end">
									<div class="avatar-group">
										<a href="#" class="avatar avatar-xs rounded-circle" data-toggle="tooltip"
											...
											<img alt="Image placeholder" src="https://www.aragon.cm38.de/assets/img/theme/team-1.jpg" class="" />
										</a>
										<a href="#" class="avatar avatar-xs rounded-circle" data-toggle="tooltip"
									...
									<small class="font-weight-bold pl-2">and 30+ more</small>
								</div>
							</div>
						</div>
						<!-- Comments -->
						<div class="mb-1">
							<div class="media media-comment">
								<img alt="Image placeholder" class="avatar avatar-lg media-comment-avatar rounded-circle"
									src="https://www.aragon.cm38.de/assets/img/theme/team-1.jpg" />
								<div class="media-body">
									<div class="media-comment-text">
										<h6 class="h5 mt-0">Michael Lewis</h6>
										<p class="lh-160 text-sm">
											Cras sit amet nibh libero nulla vel metus scelerisque ante sollicitudin. Cras purus odio vestibulum in
											vulputate
											viverra turpis.
										</p>
										<div class="icon-actions">
							...
							<div class="media media-comment">
								<img alt="Image placeholder" class="avatar avatar-lg media-comment-avatar rounded-circle"
									src="https://www.aragon.cm38.de/assets/img/theme/team-2.jpg" />
								<div class="media-body">
									<div class="media-comment-text">
							...
							<div class="media align-items-center">
								<img alt="Image placeholder" class="avatar avatar-lg rounded-circle mr-4"
									src="https://www.aragon.cm38.de/assets/img/theme/team-3.jpg" />
								<div class="media-body">
									<form>
									...
									<tbody class="list">
										...
										<tr>
											<th scope="row">
												<div class="media align-items-center">
													<a href="#" class="avatar rounded-circle mr-3">
														<img alt="Image placeholder" src="https://www.aragon.cm38.de/assets/img/theme/vue.jpg" />
													</a>
													<div class="media-body">
					...
					<div class="card bg-gradient-danger">
						...
						<div class="card-body">
							<div class="row justify-content-between align-items-center">
								<div class="col">
									<img src="https://www.aragon.cm38.de/assets/img/icons/cards/bitcoin.png" alt="Image placeholder" />
								</div>
								<div class="col-auto">
