        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card bg-default p-3">
                    <h1 class="ml-2 text-white">WELCOME SUPER ADMIN !</h1>
                ...
                <div class="card bg-default">
                    <div class="card-header bg-transparent">
                        <div class="row align-items-center">
                            <div class="col">
                                <h5 class="text-light text-uppercase ls-1 mb-1">STOCK CARD REMINDER</h5>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <table class="table-sm table-success table">
                            <thead>
                                <th>Item Code</th>
                                <th>Item Name</th>
                                <th>Caetegory</th>
            ...
            <div class="col-xl-12">
                <div class="card bg-warning">
                    <div class="card-header bg-transparent">
                        <div class="row align-items-center">
                            <div class="col">
                                <h5 class="text-light text-uppercase ls-1 mb-1">PROJECT ON PROGRESS</h5>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <table class="table-sm table-primary w-100 table">
                                    <thead>
                                        <th>Project Code</th>
                                        <th>Project Name</th>
                                        <th>Customer Code</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>PRJ23123</td>
                                            <td>Pembangunan Masjid Albarokah</td>
                                            <td>CUST001</td>
                                            <td>Pt X Gumilar</td>
                                            <td>Rp 73.000.000.000</td>
                                        </tr>
                                        <tr>
                                            <td>PRJ23123</td>
                                            <td>Pembangunan JEMBATAN SURAMADU</td>
                                            <td>CUST001</td>
                                            <td>Pt Y Gumilar</td>
                            ...
                            <li class="list-group-item px-0">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        ...
                                        <a href="#" class="avatar rounded-circle">
                                            <img alt="Image placeholder"
                                                src="https://www.aragon.cm38.de/assets/img/theme/team-4.jpg" />
                                        </a>
                                    </div>
                                    <div class="col ml--2">
                                        <h4 class="mb-0">
                            ...
                            <li class="list-group-item px-0">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        ...
                                        <a href="#" class="avatar rounded-circle">
                                            <img alt="Image placeholder"
                                                src="https://www.aragon.cm38.de/assets/img/theme/bootstrap.jpg" />
                                        </a>
                                    </div>
                                    <div class="col">
                            ...
                            <li class="list-group-item px-0">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        ...
                                        <a href="#" class="avatar rounded-circle">
                                            <img alt="Image placeholder"
                                                src="https://www.aragon.cm38.de/assets/img/theme/angular.jpg" />
                                        </a>
                                    </div>
                                    <div class="col">
                            ...
                            <li class="list-group-item px-0">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        ...
                                        <a href="#" class="avatar rounded-circle">
                                            <img alt="Image placeholder"
                                                src="https://www.aragon.cm38.de/assets/img/theme/sketch.jpg" />
                                        </a>
                                    </div>
                                    <div class="col">
                            ...
                            <li class="list-group-item px-0">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        ...
                                        <a href="#" class="avatar rounded-circle">
                                            <img alt="Image placeholder"
                                                src="https://www.aragon.cm38.de/assets/img/theme/react.jpg" />
                                        </a>
                                    </div>
                                    <div class="col">
                ...
                <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                        <div class="d-flex align-items-center">
                            <a href="#"> <img src="https://www.aragon.cm38.de/assets/img/theme/team-1.jpg"
                                    class="avatar" /> </a>
                            <div class="mx-3">
                                ...
                                <div class="media-body">
                                    <div class="media-comment-text">
                                        ...
                                        <p class="lh-160 text-sm">
                                            Cras sit amet nibh libero nulla vel metus scelerisque ante sollicitudin. Cras
                                        ...
                                        <tr>
                                            <th scope="row">
                                                <div class="media align-items-center">
                                                    <a href="#" class="avatar rounded-circle mr-3">
                                                        <img alt="Image placeholder"
                                                            src="https://www.aragon.cm38.de/assets/img/theme/vue.jpg" />
                                                    </a>
                                                    <div class="media-body">
                    ...
                    <div class="card bg-gradient-danger">
                        ...
                        <div class="card-body">
                            <div class="row justify-content-between align-items-center">
                                <div class="col">
                                    <img src="https://www.aragon.cm38.de/assets/img/icons/cards/bitcoin.png"
            ...
            <div class="row align-items-center justify-content-lg-between">
                <div class="col-lg-6">
                    <div class="copyright text-lg-left text-muted text-center">
                        &copy; 2018
                        <a href="https://www.creative-tim.com" class="font-weight-bold ml-1" target="_blank">Creative
                            Tim</a>
                    </div>
                </div>
                <div class="col-lg-6">
