                ...
                <div class="row">
                    <div class="col">
                        <div class="card" style="min-height: 800px">
                            ...
                            <div class="card-body">
                                <button class="btn btn-outline-primary btnaddnew mb-3"><i class="fas fa-plus"></i> Add New
                                    COA</button>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control inputcode" type="text" name="code"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control inputdescription" name="dk"
                                            style="font-weight: bolder">
