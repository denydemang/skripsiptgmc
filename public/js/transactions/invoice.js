...
$(document).ready(function () {
  ...
  const columns = [
    ...
    { data: 'project_realisation_code', name: 'project_realisation_code', title: 'Project Realisation Code', searchable: false },
    { data: 'project_code', name: 'project_code', title: 'Project Code', searchable: false },
    { data: 'project_name', name: 'project_name', title: 'Project Name', searchable: false },
