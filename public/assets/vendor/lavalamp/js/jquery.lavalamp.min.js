...
!(function (a) {
  ...
  var t = {
      ...
      return (
        ...
        this.each(function () {
          ...
          0 === y.length && (y = T.eq(0)),
            b
              .addClass("lavalamp")
              .data({ lavalampActive: y, isAnim: !1, settings: t });
          ...
          var j = y.outerWidth(o),
            I = y.outerHeight(o),
            O = y.position().top,
            C = y.position().left,
            x = y.css("marginTop"),
            D = y.css("marginLeft");
          o || ((D = parseInt(D)), (x = parseInt(x)), (C += D), (O += x)),
            A.css({
              width: j,
              height: I,
          ...
          if (
            ...
            u &&
              (b.on("mouseenter", ".lavalamp-item", e),
              b.on("mouseleave", ".lavalamp-item", i)),
            d &&
              (b.on("focusin", ".lavalamp-item", n),
            ...
            s &&
              T.click(function () {
                (y = a(this)), b.data("lavalampActive", y).lavalamp("update");
              }),
            r)
          ) {
    ...
    destroy: function () {
      return this.each(function () {
        ...
        if (
          (m &&
            (t.off("mouseenter", ".lavalamp-item", e),
            t.off("mouseleave", ".lavalamp-item", i)),
          r &&
            (t.off("focusin", ".lavalamp-item", n),
        ...
        t.children(".lavalamp-object").remove(), t.removeData();
      });
    },
    update: function () {
      return this.each(function () {
        ...
        e.addClass("lavalamp-item").css({ zIndex: 5, position: "relative" }),
          t.lavalamp("anim", i);
      });
    },
    anim: function (a) {
      var t = this,
        ...
        p = a.css("marginTop"),
        u = a.css("marginLeft");
      n || ((u = parseInt(u)), (p = parseInt(p)), (r += u), (m += p)),
        t.data("isAnim", !0),
        l.css({
          width: o,
          height: s,
  ...
  a.fn.lavalamp = function (e) {
    return t[e]
      ...
      : "object" != typeof e && e
      ? void a.error("Method " + e + " does not exist on jQuery.lavalamp")
