...
class PurchaseMiddleware
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $viewRoute = ['admin.purchase'];
        $updateRoute = ['admin.editProjectView'];
        $deleteRoute = ['admin.deletepurchase'];
        $createRoute = ['admin.addPurchaseView'];
        $approveRoute = ['admin.approvepurchase'];
        $printRoute = ['admin.printdetailpurchase','admin.printjurnalpurchase' , 'printrecappurchase'];
