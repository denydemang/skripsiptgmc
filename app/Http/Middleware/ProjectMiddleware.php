...
class ProjectMiddleware
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $viewRoute = ['admin.getViewProject'];
        $updateRoute = ['admin.editProjectView'];
        $deleteRoute = ['admin.deleteDataProject'];
        $createRoute = ['admin.addProjectView'];
        $approveRoute = ['admin.startProject'];
        $printRoute = ['admin.printjournal','admin.printproject', 'admin.printprojectrecap'];
