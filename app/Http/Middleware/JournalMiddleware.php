...
class JournalMiddleware
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $allowedApproveRoles = [$Admin, $Keuangan];
        $allowedPrintRoles = [$Admin, $Keuangan, $Direktur];

        $viewRoute = ['admin.journal'];
        $updateRoute = ['admin.editJournalView'];
        $deleteRoute = ['admin.deletejournal'];
        $createRoute = ['admin.addJournalView'];
        $approveRoute = ['admin.postingjournal'];
        $printRoute = ['admin.printjournalrecap'];
