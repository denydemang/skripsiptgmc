...
class ReceiptMiddleware
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $viewRoute = ['admin.receipt'];
        $updateRoute = ['admin.editReceiptView'];
        $deleteRoute = ['admin.deletereceipt'];
        $createRoute = ['admin.addReceiptView'];
        $approveRoute = ['admin.approvereceipt'];
        $printRoute = ['admin.printdetailreceipt','admin.printjurnalreceipt' , 'printrecapreceipt'];
