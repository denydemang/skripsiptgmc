...
class AdvancedReceiptMiddleware
{
    /**
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $viewRoute = ['admin.advancedreceipt'];
        $updateRoute = ['admin.editAdvancedReceiptView'];
        $deleteRoute = ['admin.deletear'];
        $createRoute = ['admin.addAdvancedReceiptView'];
        $approveRoute = ['admin.approvear'];  
        $printRoute = ['admin.printdetailar','admin.printjurnalar' , 'printrecapar'];
