...
class PaymentMiddleware
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $viewRoute = ['admin.payment'];
        $updateRoute = ['admin.editPaymentView'];
        $deleteRoute = ['admin.deletepayment'];
        $createRoute = ['admin.addPaymentView'];
        $approveRoute = ['admin.approvepayment'];
        $printRoute = ['admin.printdetailpayment','admin.printjurnalpayment' , 'printrecappayment'];
