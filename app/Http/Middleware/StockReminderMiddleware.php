...
class StockReminderMiddleware
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $user = Auth::user();
        $allowedViewRoles = [$Admin,$Logistik,$Keuangan , $Direktur];
        $allowedUpdateRoles = [$Admin,$Logistik];
        $allowedDeleteRoles = [$Admin, $Logistik];
        $allowedCreateRoles = [$Admin, $Logistik];
        $allowedApproveRoles = [$Admin, $Logistik, $Direktur];
        $allowedPrintRoles = [$Admin, $Logistik, $Direktur];

        $viewRoute = ['admin.stockreminder'];
        $updateRoute = [];
        $deleteRoute = [];
        $createRoute = [];
        $approveRoute = [];
        $printRoute = ['admin.printstockreminder'];
