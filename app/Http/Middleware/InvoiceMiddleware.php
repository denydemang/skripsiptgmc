...
class InvoiceMiddleware
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $viewRoute = ['admin.invoice'];
        $updateRoute = ['admin.editInvoiceView'];
        $deleteRoute = ['admin.deleteinvoices'];
        $createRoute = ['admin.addInvoiceView'];
        $approveRoute = ['admin.approveinvoices'];
        $printRoute = ['admin.printdetailinvoice','admin.printjurnalinvoice' , 'printrecapinvoice'];
